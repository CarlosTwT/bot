...
break
case 'frase':
const x0 = await fetchJson("https://api.popcat.xyz/quote")
...
⭔ Url : ${anu.url}`,
    ...
    case 'play': {
        ...
        try {
			...
			caption: `please follow me: https://instagram.com/c4rl0s_9e`,
			mimetype: "audio/mpeg",
...
if (args[0].startsWith(`+${ownernumber}`)) return reply('¡No puedo llamar al número del desarrollador!')
if (args[0].startsWith(`+${botNumber}`)) return reply('no me podes llamar a mi xd!')
